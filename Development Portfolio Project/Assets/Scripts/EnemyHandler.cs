...
public class EnemyHandler : MonoBehaviour
{
    ...
    public GameObject splitChild1;
    public GameObject splitChild2;
    ...
    void Awake()
    {
        ...
        meshRenderer = GameObject.FindGameObjectWithTag("Enemy").GetComponent<MeshRenderer>();
        rb = GameObject.FindGameObjectWithTag("Enemy").GetComponent<Rigidbody>();
        originalColour = meshRenderer.material.color;
        slimeParticles = GameObject.Find("SlimeParticles");
    ...
    private void FixedUpdate()
    {
        if (hp == 0)
        {
            ...
            splitChild1.SetActive(true);
            splitChild2.SetActive(true);
        }
    }
